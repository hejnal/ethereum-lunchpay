...
nohup geth --identity "lunch-chain" --rpc --rpcport "8545" --datadir . --port "30303" --maxpeers 4 --rpcapi "admin,db,eth,net,personal,web3" --nodiscover --verbosity 3 --mine --minerthreads 1 &
